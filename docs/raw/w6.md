Perfect.
This is the **most important step** for correctness and enterprise-grade behavior.
...
## Step 7 Preview (Critical)

👉 **Persistence, Rehydration & Idempotency**
...
Say **“go step 7”** and we’ll finish the core engine.
