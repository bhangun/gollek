...
record DirectForwardMetalHalfLinearExecutionPlan(
        ...
        boolean nf4Weight,
        boolean nf4MatvecCandidate,
        boolean int4Weight,
        boolean int4MatvecCandidate) {
    ...
    static DirectForwardMetalHalfLinearExecutionPlan from(
        ...
        return new DirectForwardMetalHalfLinearExecutionPlan(
                ...
                nf4Weight,
                singleRow && nf4Weight
                        && capabilities.supportsMatvecTransposedRightNf4(),
                int4Weight,
                singleRow && int4Weight
                        && capabilities.supportsMatvecTransposedRightInt4());
    ...
    String halfMatvecPath() {
        ...
        String int4MatvecPath() {
        return "int4_matvec";
    }

    String nf4MatvecPath() {
        return "nf4_matvec";
    }
