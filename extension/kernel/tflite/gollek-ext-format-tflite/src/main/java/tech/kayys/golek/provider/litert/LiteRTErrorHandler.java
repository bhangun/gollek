...
public class LiteRTErrorHandler {
    ...
    private ErrorClassification classifyError(Throwable error) {
        if (error instanceof tech.kayys.gollek.spi.exception.InferenceException) {
            tech.kayys.gollek.spi.exception.InferenceException ie = (tech.kayys.gollek.spi.exception.InferenceException) error;
