...
* Config: `inference-gollek/adapter/gollek-ext-format-gguf/src/main/java/tech/kayys/gollek/inference/gguf/GGUFConfig.java`
...
```bash
mvn clean install -pl repository/gollek-model-repo-hf,inference/format/gguf/gollek-ext-format-gguf,sdk/gollek-sdk-java-local -am -DskipTests
```
...
mvn clean compile -f inference-gollek/pom.xml -pl :gollek-ext-format-gguf,:gollek-gguf-converter -am
```