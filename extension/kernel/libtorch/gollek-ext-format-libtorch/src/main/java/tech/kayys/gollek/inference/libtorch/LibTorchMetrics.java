...
public class LibTorchMetrics {
    ...
    public void recordAdapterInitWait(Duration duration) {
        ...
        adapterMetricsRecorder.recordInitWait(PROVIDER_TAG, duration);
    }
    ...
    public void recordAdapterApply(Duration duration) {
        ...
        adapterMetricsRecorder.recordApply(PROVIDER_TAG, AdapterMetricSchema.TYPE_UNKNOWN, duration);
    }
    ...
    public void recordAdapterPairCacheHit() {
        ...
        adapterMetricsRecorder.recordCacheHit(PROVIDER_TAG, AdapterMetricSchema.SCOPE_PAIR_INDEX);
    }
    ...
    public void recordAdapterPairCacheMiss() {
        ...
        adapterMetricsRecorder.recordCacheMiss(PROVIDER_TAG, AdapterMetricSchema.SCOPE_PAIR_INDEX);
    }
