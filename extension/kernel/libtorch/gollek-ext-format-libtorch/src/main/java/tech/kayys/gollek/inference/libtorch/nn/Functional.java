 ...
 * Mirrors {@code torch::nn::functional}.
 * <p>
...
public final class Functional {
     ...
     * Batch normalization.
     */
    public static Tensor batchNorm(Tensor input, Tensor weight, Tensor bias,
     ...
     */
    public static Tensor maxPool2d(Tensor input, long kernelSize, long stride, long padding) {
        Arena opArena = Arena.ofConfined();
        try {
            MethodHandle fn = LibTorchBinding.getInstance().bind(
                    "at_max_pool2d",
     ...
     */
    public static Tensor adaptiveAvgPool2d(Tensor input, long outputH, long outputW) {
        Arena opArena = Arena.ofConfined();
        try {
            MethodHandle fn = LibTorchBinding.getInstance().bind(
    ...
    private static Tensor invokeUnary(String fnName, Tensor input) {
        Arena opArena = Arena.ofConfined();
        try {
            MethodHandle fn = LibTorchBinding.getInstance().bind(
