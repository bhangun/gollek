...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            llama_h.C_POINTER.withName("__routine"),
            llama_h.C_POINTER.withName("__arg"),
            llama_h.C_POINTER.withName("__next")).withName("__darwin_pthread_handler_rec");
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = llama_h.upcallHandle(__routine.Function.class, "apply", $DESC);
