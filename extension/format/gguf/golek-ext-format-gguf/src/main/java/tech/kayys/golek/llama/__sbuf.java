...
public class __sbuf {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            llama_h.C_POINTER.withName("_base"),
            llama_h.C_INT.withName("_size"),
            MemoryLayout.paddingLayout(4)).withName("__sbuf");
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * unsigned char *_base
     * }
     */
