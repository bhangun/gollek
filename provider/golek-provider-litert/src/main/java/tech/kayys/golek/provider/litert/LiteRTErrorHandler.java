...
public class LiteRTErrorHandler {
    ...
    private ErrorClassification classifyError(Throwable error) {
        if (error instanceof tech.kayys.golek.core.exception.InferenceException) {
            tech.kayys.golek.core.exception.InferenceException ie = (tech.kayys.golek.core.exception.InferenceException) error;
            return new ErrorClassification(ie.getErrorCode(), ie.isRetryable());
        }
