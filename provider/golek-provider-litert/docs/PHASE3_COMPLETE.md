...
ModelManifest getManifest(String tenantId, String modelId, String version)
List<ModelSummary> listModels(String tenantId, int page, int size)
void promoteModel(String tenantId, String modelId, ModelStage targetStage)
void deprecateVersion(String tenantId, String modelId, String version)
Uni<ConversionJob> requestConversion(String tenantId, String modelId, String targetFormat)
ModelStats getModelStats(String tenantId, String modelId)
```
...
23. ✅ TenantContext.java (70 lines) ⭐
24. ✅ TenantContextFilter.java (90 lines) ⭐
...
HTTP POST /v1/models (upload)
   ↓
TenantContextFilter validates tenant
   ↓
