...
public class DefaultModelRouterService implements ModelRouterService {
    ...
    @Override
    public String selectProvider(String modelId, String tenantId) {
        return selectProvider(modelId, tenantId, Map.of());
    }

    @Override
    public String selectProvider(String modelId, String tenantId, Map<String, Object> requestContext) {
        ...
        return availableProviders.stream()
            .map(providerId -> {
                double score = calculateScore(modelId, providerId, tenantId, requestContext);
    ...
    private String findFallbackProvider(String modelId) {
        ...
        List<String> allProviders = List.of("openai-provider", "anthropic-provider", "llama-provider", "mistral-provider");
    ...
    @Override
    public double getProviderScore(String modelId, String providerId, String tenantId) {
        return calculateScore(modelId, providerId, tenantId, Map.of());
    }

    @Override
    public RoutingDecision getRoutingDecision(String modelId, String tenantId, Map<String, Object> context) {
        String selectedProvider = selectProvider(modelId, tenantId, context);
        List<String> candidates = getAvailableProviders(modelId);
        double score = selectedProvider != null ? getProviderScore(modelId, selectedProvider, tenantId) : 0.0;
    ...
    private double calculateScore(String modelId, String providerId, String tenantId, Map<String, Object> requestContext) {
