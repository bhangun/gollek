package tech.kayys.wayang.tool.parser.impl;
...
/**
 * Default implementation of ToolGenerationService.
 */
@ApplicationScoped
public class DefaultOpenApiToolGenerator implements ToolGenerationService {

    private static final Logger LOG = LoggerFactory.getLogger(DefaultOpenApiToolGenerator.class);
    ...
    private Uni<OpenApiSource> createOpenApiSource(
        ...
        return Uni.createFrom().item(() -> {
            ...
            source.setSpecVersion(openApi.getOpenapi());
            source.setSpecHash(calculateHash(request.source()));
        ...
        if (operation.getRequestBody() != null) {
            ...
            if (content != null) {
                ...
                if (mediaType != null && mediaType.getSchema() != null) {
                    Map<String, Object> bodySchema = convertSchema(mediaType.getSchema());
    ...
    /**
     * Converts an OpenAPI schema to a generic map representation
     */
    private Map<String, Object> convertSchema(io.swagger.v3.oas.models.media.Schema schema) {
        if (schema == null) {
            return new HashMap<>();
        }
        ...
        if (schema.getProperties() != null) {
            Map<String, Object> properties = new HashMap<>();
            // Cast the properties map to avoid typing issues
            ...
            for (String propName : props.keySet()) {
                ...
                if (propValue instanceof io.swagger.v3.oas.models.media.Schema) {
                    convertedValue = convertSchema((io.swagger.v3.oas.models.media.Schema) propValue);
                } else {
