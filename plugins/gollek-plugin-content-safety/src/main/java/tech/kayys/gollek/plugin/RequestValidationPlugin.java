...
public class RequestValidationPlugin implements InferencePhasePlugin {
    ...
    @Override
    public void onConfigUpdate(Map<String, Object> newConfig) throws GollekConfigurablePlugin.ConfigurationException {
        ...
        try {
            ...
            throw new GollekConfigurablePlugin.ConfigurationException("Invalid configuration value", e);
        }
    }
