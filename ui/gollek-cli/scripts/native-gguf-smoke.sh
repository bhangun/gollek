...
NATIVE_BIN="${GOLEK_CLI_NATIVE_BIN:-$TARGET_DIR/gollek-cli-1.0.0-SNAPSHOT-runner}"
RUNNER_JAR="${GOLEK_CLI_RUNNER_JAR:-$TARGET_DIR/gollek-cli-1.0.0-SNAPSHOT-runner.jar}"
