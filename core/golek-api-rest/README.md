# Golek API REST Module

This module provides REST API endpoints for the Golek inference platform, offering a unified interface for model inference, management, and monitoring operations.
...
golek.multitenancy.enabled=false

# Inference timeouts
golek.inference.timeout=30S
golek.inference.max-retries=2

# Fault tolerance settings
golek.fault-tolerance.bulkhead-size=100
golek.fault-tolerance.queue-size=50
```
