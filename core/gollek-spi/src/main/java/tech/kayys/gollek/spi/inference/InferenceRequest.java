...
public final class InferenceRequest {
    ...
    /**
     * The compute stage for disaggregated prefill/decode routing.
     * Null means auto-detect (defaults to COMBINED).
     */
    @Nullable
    private final InferenceStage inferenceStage;

    /**
     * Estimated prompt token count for stage routing decisions.
     * -1 means unknown (will be counted later).
     */
    ...
    /**
     * Get the inference stage for disaggregated routing.
     * Returns COMBINED if not explicitly set.
     */
    ...
    /**
     * Get the prompt token count, or -1 if unknown.
     */
    ...
    /**
     * Whether this request has an explicitly set inference stage.
     */
    ...
    public static class Builder {
        ...
        public Builder inferenceStage(InferenceStage stage) {
            this.inferenceStage = stage;
            return this;
        }

        public Builder promptTokenCount(int count) {
            this.promptTokenCount = count;
            return this;
        }
        ...
        public InferenceRequest build() {
            ...
            return new InferenceRequest(
                    ...
                    inferenceStage, promptTokenCount);
        }
    }
