...
public final class HuggingFaceRepository implements ModelRepository {
            ...
            try {
                ...
                if (isAutoDownloadEnabled() && !"community".equals(requestId)) {
                    ...
                    Path downloaded = downloadBestArtifact(repoId, targetFolder,
                            tech.kayys.gollek.spi.model.PullOptions.DEFAULT);
                    if (downloaded != null) {
    ...
    private Path downloadBestArtifact(String repoId, Path targetDir, tech.kayys.gollek.spi.model.PullOptions options)
            throws Exception {
