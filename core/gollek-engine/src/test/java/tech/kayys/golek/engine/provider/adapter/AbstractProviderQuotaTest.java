...
public class AbstractProviderQuotaTest {
    ...
    void setUp() throws Exception {
        ...
        java.lang.reflect.Field thresholdField = tech.kayys.gollek.engine.provider.adapter.AbstractProvider.class
                .getDeclaredField("circuitBreakerFailureThreshold");
        thresholdField.setAccessible(true);
        thresholdField.setInt(provider, 5);

        java.lang.reflect.Field timeoutField = tech.kayys.gollek.engine.provider.adapter.AbstractProvider.class
    ...
    void shouldDenyInferenceWhenQuotaExhausted() {
        ...
        provider.infer(request)
                .subscribe().withSubscriber(UniAssertSubscriber.create())
                .awaitFailure()
                .assertFailedWith(tech.kayys.gollek.spi.routing.QuotaExhaustedException.class);
