...
import tech.kayys.gollek.spi.inference.BatchConfig;
import tech.kayys.gollek.spi.inference.BatchInferenceRequest;
import tech.kayys.gollek.spi.inference.BatchMetrics;
import tech.kayys.gollek.spi.inference.BatchResponse;
import tech.kayys.gollek.spi.inference.BatchResult;
import tech.kayys.gollek.spi.inference.BatchScheduler;
import tech.kayys.gollek.spi.inference.BatchStrategy;
...
public class DefaultBatchScheduler implements BatchScheduler {
    ...
    public DefaultBatchScheduler(InferenceOrchestrator orchestrator, BatchConfig config) {
