...
import tech.kayys.gollek.core.config.EnhancedConfigurationManager;
import tech.kayys.gollek.core.plugin.PluginManager;
    ...
    private void registerLocalRunners() {
        try {
            for (String runnerName : runnerFactory.getAvailableRunners()) {
                ...
                var provider = new tech.kayys.gollek.engine.provider.adapter.RunnerBridgeProvider(
