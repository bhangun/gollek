...
public class MultimodalRequest {
    ...
    /**
     * Returns the request timeout in milliseconds. {@code 0} means no explicit
     * timeout.
     *
    ...
    public static class Builder {
        ...
        /**
         * @param inputs one or more multimodal content items; {@code null} is treated
         *               as empty
         */
    ...
    /**
     * Controls the generation output: modalities, token limits, and sampling
     * parameters.
     */
    public static class OutputConfig {
        ...
        public static class Builder {
            ...
            /**
             * @param modalities desired output modalities; {@code null} defaults to
             *                   {@code [TEXT]}
             */
