...
public class RunnerStats {
    ...
    public RunnerStats(long totalRequests, long failedRequests, long averageLatencyMs,
    ...
    public static class Builder {
        ...
        public RunnerStats build() {
            return new RunnerStats(totalRequests, failedRequests, averageLatencyMs, p95LatencyMs, p99LatencyMs);
        }
    }
}
