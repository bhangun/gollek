 ...
 * }
 */
public class ggml_backend_sched_eval_callback {
    ...
    private static final MethodHandle UP$MH = llama_h.upcallHandle(ggml_backend_sched_eval_callback.Function.class,
            "apply", $DESC);
