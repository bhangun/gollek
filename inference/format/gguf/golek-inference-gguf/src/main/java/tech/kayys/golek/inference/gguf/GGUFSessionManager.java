...
public class GGUFSessionManager {
     ...
     */
    public SessionContext getSession(String tenantId, String modelId, GGUFProviderConfig config) {
        ensureInitialized();

        String poolKey = buildPoolKey(tenantId, modelId);
    ...
    private String buildPoolKey(String tenantId, String modelId) {
