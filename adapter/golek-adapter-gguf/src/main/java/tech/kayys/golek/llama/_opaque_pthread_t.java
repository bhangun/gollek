...
public class _opaque_pthread_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            llama_h.C_LONG.withName("__sig"),
            llama_h.C_POINTER.withName("__cleanup_stack"),
            MemoryLayout.sequenceLayout(8176, llama_h.C_CHAR).withName("__opaque")).withName("_opaque_pthread_t");
