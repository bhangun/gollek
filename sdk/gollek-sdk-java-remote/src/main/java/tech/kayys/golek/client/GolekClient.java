...
/**
 * Remote client for interacting with the Gollek inference engine via HTTP API.
 * Implements the core GollekSdk interface for remote access.
 */
public class GollekClient implements GollekSdk {
    ...
    /**
     * Builder for creating GollekClient instances.
     */
