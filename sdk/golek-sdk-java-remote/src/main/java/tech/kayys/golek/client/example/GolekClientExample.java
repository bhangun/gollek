...
import tech.kayys.golek.client.model.AsyncJobStatus;
...
public class GolekClientExample {
    ...
    private static void batchInferenceExample(GolekClient client) {
        ...
        try {
            ...
            var request1 = InferenceRequestBuilder.builder()
                    .model("llama3:latest")
                    .userMessage("What is 2+2?")
                    .maxTokens(10)
                    .build();
                    
            var request2 = InferenceRequestBuilder.builder()
                    .model("llama3:latest")
                    .userMessage("What is the largest planet?")
                    .maxTokens(20)
                    .build();
                    
            var request3 = InferenceRequestBuilder.builder()
                    .model("llama3:latest")
